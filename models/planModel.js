...
const { convertToUTC8, convertActiveTime, convertDayToUTC8 } = require("../utils/dateUtils");
  ...
  },
  {
    ...
    toObject: {
      ...
      transform: (doc, ret) => {
        ...
        if (ret.startedAt) ret.startedAt = convertDayToUTC8(ret.startedAt);
        if (ret.activeTime) ret.activeTime = convertActiveTime(convertDayToUTC8(ret.createdAt));
